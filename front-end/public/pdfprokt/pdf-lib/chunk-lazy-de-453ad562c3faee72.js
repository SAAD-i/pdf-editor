        ...
        M = (0, n.memo)((e) => {
          ...
          const m = t.map((e) => {
            ...
            return n
              ...
              : {
                  item: S(S({}, t), {}, { onPress: null == d ? void 0 : d(t) }),
                  index: a,
                };
          });
          return (
      ...
      const T = (e) => {
          ...
          return n.createElement(
            "div",
            {
              ...
              className: r()(t.importedDocument, {
                [t.importedDocumentMovePreview]: s,
              }),
            },
            n.createElement(
              "div",
        ...
        j = (e) => {
          ...
          return n.createElement(
            ...
            n.createElement(
              "div",
              {
                className: r()(o.movePreviewPages, {
                  [o.movePreviewPagesLoose]: "loose" === a,
                }),
              },
              t
            ),
        ...
        H = (e) => {
          ...
          const Ie = (0, n.useCallback)(() => {
              const e = E.get(0),
                ...
                a = K(
                  ...
                  1 === X.size
                    ? { afterPageIndex: X.first() }
                    : { beforePageIndex: 0 }
                );
              ve(a), q(X.clear());
            }, [E, X, ve]),
            we = (0, n.useCallback)(() => {
              ve({ type: "removePages", pageIndexes: X.toArray() }),
                q(X.clear());
            }, [ve, X]),
            ke = (0, n.useCallback)(() => {
              ve({ type: "duplicatePages", pageIndexes: X.toArray() }),
                q(X.clear());
            }, [ve, X]),
            Ee = (0, n.useCallback)(() => {
              ve({
            ...
            Ce = (0, n.useCallback)(
              (e) => {
                ...
                isNaN(o) || (a = Math.min(Math.max(o, 0), J.size).toString()),
                  ie(a);
              },
              [J.size]
            ),
                ...
                (t.onchange = (t) => {
                  ...
                  for (const a of t.target.files) {
                    ...
                    a.arrayBuffer()
                      ...
                      .catch((e) => {
                        throw new d.p2(
                          `Could not read the imported file: ${e.message}`
                        );
                      });
                  }
                }),
            ...
            Ve = (e, t, a, o) => {
              ...
              switch (((0, d.kG)(null != s), s.type)) {
                case "page":
                  ...
                  break;
                case "newPage": {
                  const { rotatedWidth: e, rotatedHeight: o } = (0, u.X)(
                    s.size,
                    s.rotation,
                    t,
                    a
              ...
              return {
                ...
                props:
                  "page" === s.type
                    ? { "data-original-page-index": s.page.pageIndex }
                    : {},
              };
            },
          ...
          (0, n.useLayoutEffect)(() => {
            ...
            const n = [].findIndex.call(
              t,
              (e, t) =>
                "spacer" !== x[t].type && ((o += e.clientWidth), o > rt.width)
            );
          ...
          (0, n.useLayoutEffect)(() => {
            ...
            const t = (e) => {
              ...
              else if (e.altKey && e.shiftKey && !a && "arrowright" === t && Ye)
                Ne();
            ...
            wt = n.createElement(
              "div",
              {
                className: r()(
                  ...
                  "PDFPROKt-DocumentEditor-MoveDialog"
                ),
                ref: oe,
              },
              n.createElement(
          ...
          const Dt = (0, n.useMemo)(
              () => ({
                cancel: {
                  ...
                  onPress: We,
                  className: "PDFPROKt-DocumentEditor-CancelButton",
                },
                "selected-pages": {
                  ...
                  className: r()({
                    ...
                    "PDFPROKt-DocumentEditor-PagesSelectedIndicator": !0,
                  }),
                },
                spacer: {
                  ...
                  className: r()({
                    [H.spacer]: !0,
                    "PDFPROKt-DocumentEditor-Spacer": !0,
                  }),
                },
                "loading-indicator": {
                  element: A || (A = n.createElement(I.Z, null)),
                  hide: !Q,
                  className: "PDFPROKt-DocumentEditor-LoadingIndicator",
                },
                "save-as": {
                  element: n.createElement(m.zx, null, F(b.Z.saveAs)),
                  onPress: _e,
                  disabled: Q,
                  className: "PDFPROKt-DocumentEditor-SaveAsButton",
                },
                save: {
                  element: n.createElement(m.zx, { primary: !0 }, F(b.Z.save)),
                  disabled: Y.isEmpty() || Q,
                  onPress: $e,
                  className: "PDFPROKt-DocumentEditor-SaveButton",
                },
              }),
              [H, F, We, _e, $e, Q, Y, X]
            ),
          ...
          return n.createElement(
            ...
            n.createElement(
              "div",
              {
                className: r()(
                  H.toolbar.root,
                  H.toolbarRoot,
                  "PDFPROKt-DocumentEditor-Toolbar"
                ),
                style: { flex: 0 },
              },
              n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(
                "div",
                {
                  className: r()(H.pagesGrid, {
                    [H.pagesGridLargeThumbnails]: te,
                  }),
                  ref: St,
                },
                n.createElement(v.Z, {
                  ...
                  cssPrefix: "PDFPROKt-DocumentEditor",
            ...
            n.createElement(
              "div",
              { className: r()(H.bottomBar, "PDFPROKt-DocumentEditor-Footer") },
              Ct
            )
          );
        },
        W = (0, i.vU)({
          ...
          zoomIn: {
            ...
            description: "Zoom in the document",
          },
          zoomOut: {
            id: "zoomOut",
