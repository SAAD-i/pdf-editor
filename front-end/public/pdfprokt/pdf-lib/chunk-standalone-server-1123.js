  ...
  [4267],
  {
        ...
        cachedRenderAnnotation(e, t, n, i, r) {
          ...
          return {
            promise: new Promise(async (a, o) => {
              ...
              (this.annotationAPStreamPromises =
                this.annotationAPStreamPromises.set(e.id, a)),
                c && c(null);
              try {
                ...
                const { promise: p, cancel: f } = this.renderAPStream(
                  e,
                  l,
                  t,
                  n,
    ...
    7407: (e, t, n) => {
      ...
      function l(e) {
        let t, n;
        (0, i.kG)(
          "pdfprokt/outline-element" === e.type,
        ...
        return (
          e.children &&
            e.children.length > 0 &&
            (c.children = (0, r.aV)(e.children.map(l))),
          new s.sT(c)
        );
      }
    },
              ...
              .map(
                (e) => (
                  ...
                  new o.Z({
                    ...
                    rectsOnPage: (0, i.aV)(e.rectsOnPage).map((e) =>
                      (0, a.k)(e)
                    ),
                    isAnnotation: !!e.isAnnotation,
                    annotationRect: e.annotationRect
                      ? (0, a.k)(e.annotationRect)
                      : null,
                  })
                )
              )
